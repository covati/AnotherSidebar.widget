...
command: "osascript AnotherSidebar.widget/WorldClock.widget/WorldClock.applescript '#{options.locations}' '#{options.cityNames}' #{options.timeFormat}"
...
update: (output, domEl) ->
  ...
  if @options.widgetEnable
    ...
    div.html("<div class='wrapper sidebar'>" + timeHTML + "</div>")
    # div.html("<div class='wrapper sidebar'>" + output + "</div>")
